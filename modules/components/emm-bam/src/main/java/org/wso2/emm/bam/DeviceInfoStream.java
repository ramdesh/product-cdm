 ...
 */
public class DeviceInfoStream implements EMMStream {
	...
	public DeviceInfoStream() throws PublisherException {
		try {
			streamDefinition = new StreamDefinition(
					Constants.DEVICE_INFO_NOTIFICATIONS_STREAM_NAME,
			...
			streamDefinition.addPayloadData(Constants.GROUP_ID,
					AttributeType.STRING);
			streamDefinition.addPayloadData(Constants.INTERNAL_MEMORY_TOTAL,
					AttributeType.STRING);
			streamDefinition.addPayloadData(
					Constants.INTERNAL_MEMORY_AVAILABLE, AttributeType.STRING);
			streamDefinition.addPayloadData(Constants.LATITUDE,
					AttributeType.STRING);
			streamDefinition.addPayloadData(Constants.LONGITUDE,
					AttributeType.STRING);
			streamDefinition.addPayloadData(Constants.EXTERNAL_MEMORY_TOTAL,
					AttributeType.STRING);
			streamDefinition.addPayloadData(
					Constants.EXTERNAL_MEMORY_AVAILABLE, AttributeType.STRING);
			streamDefinition.addPayloadData(Constants.OPERATOR,
					AttributeType.STRING);
