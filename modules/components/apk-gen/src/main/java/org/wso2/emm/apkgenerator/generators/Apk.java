...
public class Apk {
	...
	public static String compileApk(String commonUtilPath, String serverIp, String password,
		...
		String wso2Carbon = ApkGenerator.workingDir + Constants.FilePath.WSO2CARBON_JKS;
		String clienTruststore = ApkGenerator.workingDir + Constants.FilePath.CLIENT_TRUST_JKS;
		String emmJKS = ApkGenerator.workingDir + Constants.FilePath.WSO2EMM_JKS;
