...
describe('Device Module', function () {
    ...
    describe('Register Android operation - Device Module', function () {
        ...
        var deviceInfo = {"username": "user", "regid": "1234", "platform": "Android",
            "osversion": "4.1.3", "type": "BYOD", "properties": {"device": "GS4", "imei": "1212122234",
                "imsi": "223456776", "model": "S5"}, "vendor": "Samsung", "email": "user@test.com",
            "mac": "3c:97:0e:84:43:05"};
    ...
    describe('Device Unregister operations - Device Module', function () {
        ...
        it('Test unRegisterAndroid', function () {
            try {
                ...
                driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, " +
                    ...
                    " values ('1',  '-1234', 'user', '1', 'APA91bEa', '4.1.2', " +
                    "'{\"device\":\"GT-I9100G\",\"model\":\"GT-I9100G\",\"imsi\":\"413025000690522\"," +
                    "\"imei\":\"358401042931186\"}', '2014-05-07 18:40:45', 'A', '1', 'samsung', '0'," +
                    " NULL, '92:1C:52:F3:53:52')");
        ...
        it('Test unRegisterIOS device', function () {
            try {
                ...
                driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, " +
                    "os_version, properties, created_date, status, byod, vendor, udid, push_token, mac) " +
                    "values ('2',  '-1234', 'user', '2', '', '7.1', '{\"device\":\"iPhone\"," +
                    "\"model\":\"5c\",\"imsi\":\"413025010690522\",\"imei\":\"358401043931186\"}', " +
                    "'2014-05-07 18:40:45', 'A', '1', 'Apple', 'APA91bEa', NULL, '92:1C:52:F3:53:52')");
                var ctx = {"udid": reg_id};
    ...
    describe('Register IOS operation - Device Module', function () {
        var device_module = require('/modules/device.js').device;
        var ctx = {"auth_token": "-1234", "username": "user", "udid": "12345", "platform": "iPhone",
            "osversion": "7.1", "type": "BYOD", "properties": {"device": "iPhone", "imei": "12121222345",
                "imsi": "223456776", "model": "5c"}, "vendor": "Apple", "email": "user@test.com",
            "mac": "4c:97:0e:84:43:05"};
        var db, device;
        ...
        function tearUp() {
            try {
                ...
                driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version," +
                    ...
                    "('2',  '-1234', 'user', '2', '', '7.1', '{\"device\":\"iPhone\",\"model\":\"5c\"," +
        ...
        it('Test getFeaturesFromDevice from android device', function () {
            try {
                ...
                driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version," +
                    ...
                    "'-1234', 'user', '1', 'APA91bEa', '4.1.2', '{\"device\":\"GT-I9100G\"," +
    ...
    describe('Is registered operation - Device Module', function () {
        ...
        it('Test isregistered for android device', function () {
            try {
                ...
                driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version," +
                    " properties, created_date, status, byod, vendor, udid, push_token, mac) values " +
                    "('1',  '-1234', 'user', '1', 'APA91bEa', '4.1.2', '{\"device\":\"GT-I9100G\"," +
                    "\"model\":\"GT-I9100G\",\"imsi\":\"413025000690522\",\"imei\":\"358401042931186\"}'," +
                    " '2014-05-07 18:40:45', 'A', '1', 'samsung', '0', NULL, '92:1C:52:F3:53:52')");
                var ctx = {"regid": udid};
    ...
    describe('Save ios push token operation - Device Module', function () {
        ...
        it('Test saveiOSPushToken operation', function () {
            try {
                ...
                driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version," +
                    " properties, created_date, status, byod, vendor, udid, push_token, mac) values ('2',  " +
                    "'-1234', 'user', '2', '', '7.1', '{\"device\":\"iPhone\",\"model\":\"5c\",\"imsi\":" +
                    "\"413025010690522\",\"imei\":\"358401043931186\"}', '2014-05-07 18:40:45', 'A', '1'," +
                    " 'Apple', 'APA91bEa', NULL, '92:1C:52:F3:53:52')");
    ...
    describe('Get pending operations - Device Module', function () {
        ...
        it('Test getPendingOperationsFromDevice', function () {
            try {
                ...
                driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version," +
                    " properties, created_date, status, byod, vendor, udid, push_token, mac) values ('1', " +
                    " '-1234', 'user', '2', '', '7.1', '{\"device\":\"iPhone\",\"model\":\"5c\"," +
                    "\"imsi\":\"413025010690522\",\"imei\":\"358401043931186\"}', '2014-05-07 18:40:45', " +
                    "'A', '1', 'Apple', 'APA91bEa', NULL, '92:1C:52:F3:53:52')");
                driver.query("insert into notifications(id, group_id, user_id, device_id, message, status," +
                    " sent_date, feature_code, feature_description, tenant_id) values ('1', '-1', 'user', " +
                    "'1', 'hi', 'P', '2014-05-07 18:10:46', '500A', 'Device Information', '-1234')");
                var result = device.getPendingOperationsFromDevice(ctx);
                var expectedResult = JSON.parse('{"feature_code" : "500A", "message" : "hi", "id" : "1",' +
                    ' "received_data" : null}');
